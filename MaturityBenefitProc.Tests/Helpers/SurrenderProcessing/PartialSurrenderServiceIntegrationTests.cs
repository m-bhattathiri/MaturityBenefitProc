...
{
    [TestClass]
    public class PartialSurrenderServiceIntegrationTests
    {
        private PartialSurrenderService _service;
        ...
        public void Integration_ServiceInstantiation_Succeeds()
        {
            ...
            Assert.IsInstanceOfType(_service, typeof(PartialSurrenderService));
            Assert.IsTrue(_service.GetType().Name == "PartialSurrenderService");
        ...
        {
            var s1 = new PartialSurrenderService();
            var s2 = new PartialSurrenderService();
            Assert.IsNotNull(s1);
            Assert.IsNotNull(s2);
        ...
        {
            var instances = Enumerable.Range(0, 10).Select(_ => new PartialSurrenderService()).ToList();
        ...
        {
            var type = typeof(PartialSurrenderService);
            Assert.IsNotNull(type);
            Assert.AreEqual("PartialSurrenderService", type.Name);
        ...
        {
            var ns = typeof(PartialSurrenderService).Namespace;
            Assert.IsNotNull(ns);
        ...
        {
            var interfaces = typeof(PartialSurrenderService).GetInterfaces();
        ...
        public void Integration_Constructor_NoException()
        {
            ...
            try { var svc = new PartialSurrenderService(); }
            catch (Exception ex) { caught = ex; }
            Assert.IsNull(caught);
            Assert.IsNotNull(_service);
            Assert.IsTrue(true);
            Assert.IsFalse(false);
            Assert.AreEqual(typeof(PartialSurrenderService), _service.GetType());
        }
        ...
        public void Integration_ToString_NotNull()
        {
            ...
            Assert.IsTrue(str.Contains("PartialSurrenderService") || str.Contains("MaturityBenefitProc"));
        ...
        {
            var other = new PartialSurrenderService();
