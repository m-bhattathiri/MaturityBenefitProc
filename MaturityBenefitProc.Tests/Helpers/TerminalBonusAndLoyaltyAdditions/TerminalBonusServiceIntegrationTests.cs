...
{
    [TestClass]
    public class TerminalBonusServiceIntegrationTests
    {
        private TerminalBonusService _service;
        ...
        public void Integration_ServiceInstantiation_Succeeds()
        {
            ...
            Assert.IsInstanceOfType(_service, typeof(TerminalBonusService));
            Assert.IsTrue(_service.GetType().Name == "TerminalBonusService");
        ...
        {
            var s1 = new TerminalBonusService();
            var s2 = new TerminalBonusService();
            Assert.IsNotNull(s1);
            Assert.IsNotNull(s2);
        ...
        {
            var instances = Enumerable.Range(0, 10).Select(_ => new TerminalBonusService()).ToList();
        ...
        {
            var type = typeof(TerminalBonusService);
            Assert.IsNotNull(type);
            Assert.AreEqual("TerminalBonusService", type.Name);
        ...
        {
            var ns = typeof(TerminalBonusService).Namespace;
            Assert.IsNotNull(ns);
        ...
        {
            var interfaces = typeof(TerminalBonusService).GetInterfaces();
        ...
        public void Integration_Constructor_NoException()
        {
            ...
            try { var svc = new TerminalBonusService(); }
            catch (Exception ex) { caught = ex; }
            Assert.IsNull(caught);
            Assert.IsNotNull(_service);
            Assert.IsTrue(true);
            Assert.IsFalse(false);
            Assert.AreEqual(typeof(TerminalBonusService), _service.GetType());
        }
        ...
        public void Integration_ToString_NotNull()
        {
            ...
            Assert.IsTrue(str.Contains("TerminalBonusService") || str.Contains("MaturityBenefitProc"));
        ...
        {
            var other = new TerminalBonusService();
