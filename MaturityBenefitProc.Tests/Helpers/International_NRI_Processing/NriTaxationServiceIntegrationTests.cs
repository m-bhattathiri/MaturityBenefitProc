...
{
    [TestClass]
    public class NriTaxationServiceIntegrationTests
    {
        private NriTaxationService _service;
        ...
        public void Integration_ServiceInstantiation_Succeeds()
        {
            ...
            Assert.IsInstanceOfType(_service, typeof(NriTaxationService));
            Assert.IsTrue(_service.GetType().Name == "NriTaxationService");
        ...
        {
            var s1 = new NriTaxationService();
            var s2 = new NriTaxationService();
            Assert.IsNotNull(s1);
            Assert.IsNotNull(s2);
        ...
        {
            var instances = Enumerable.Range(0, 10).Select(_ => new NriTaxationService()).ToList();
        ...
        {
            var type = typeof(NriTaxationService);
            Assert.IsNotNull(type);
            Assert.AreEqual("NriTaxationService", type.Name);
        ...
        {
            var ns = typeof(NriTaxationService).Namespace;
            Assert.IsNotNull(ns);
        ...
        {
            var interfaces = typeof(NriTaxationService).GetInterfaces();
        ...
        public void Integration_Constructor_NoException()
        {
            ...
            try { var svc = new NriTaxationService(); }
            catch (Exception ex) { caught = ex; }
            Assert.IsNull(caught);
            Assert.IsNotNull(_service);
            Assert.IsTrue(true);
            Assert.IsFalse(false);
            Assert.AreEqual(typeof(NriTaxationService), _service.GetType());
        }
        ...
        public void Integration_ToString_NotNull()
        {
            ...
            Assert.IsTrue(str.Contains("NriTaxationService") || str.Contains("MaturityBenefitProc"));
        ...
        {
            var other = new NriTaxationService();
