...
{
    [TestClass]
    public class CapitalGainsTaxServiceIntegrationTests
    {
        private CapitalGainsTaxService _service;
        ...
        public void Integration_ServiceInstantiation_Succeeds()
        {
            ...
            Assert.IsInstanceOfType(_service, typeof(CapitalGainsTaxService));
            Assert.IsTrue(_service.GetType().Name == "CapitalGainsTaxService");
        ...
        {
            var s1 = new CapitalGainsTaxService();
            var s2 = new CapitalGainsTaxService();
            Assert.IsNotNull(s1);
            Assert.IsNotNull(s2);
        ...
        {
            var instances = Enumerable.Range(0, 10).Select(_ => new CapitalGainsTaxService()).ToList();
        ...
        {
            var type = typeof(CapitalGainsTaxService);
            Assert.IsNotNull(type);
            Assert.AreEqual("CapitalGainsTaxService", type.Name);
        ...
        {
            var ns = typeof(CapitalGainsTaxService).Namespace;
            Assert.IsNotNull(ns);
        ...
        {
            var interfaces = typeof(CapitalGainsTaxService).GetInterfaces();
        ...
        public void Integration_Constructor_NoException()
        {
            ...
            try { var svc = new CapitalGainsTaxService(); }
            catch (Exception ex) { caught = ex; }
            Assert.IsNull(caught);
            Assert.IsNotNull(_service);
            Assert.IsTrue(true);
            Assert.IsFalse(false);
            Assert.AreEqual(typeof(CapitalGainsTaxService), _service.GetType());
        }
        ...
        public void Integration_ToString_NotNull()
        {
            ...
            Assert.IsTrue(str.Contains("CapitalGainsTaxService") || str.Contains("MaturityBenefitProc"));
        ...
        {
            var other = new CapitalGainsTaxService();
