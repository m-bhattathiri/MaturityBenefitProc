...
{
    [TestClass]
    public class FatcaComplianceServiceIntegrationTests
    {
        private FatcaComplianceService _service;
        ...
        public void Integration_ServiceInstantiation_Succeeds()
        {
            ...
            Assert.IsInstanceOfType(_service, typeof(FatcaComplianceService));
            Assert.IsTrue(_service.GetType().Name == "FatcaComplianceService");
        ...
        {
            var s1 = new FatcaComplianceService();
            var s2 = new FatcaComplianceService();
            Assert.IsNotNull(s1);
            Assert.IsNotNull(s2);
        ...
        {
            var instances = Enumerable.Range(0, 10).Select(_ => new FatcaComplianceService()).ToList();
        ...
        {
            var type = typeof(FatcaComplianceService);
            Assert.IsNotNull(type);
            Assert.AreEqual("FatcaComplianceService", type.Name);
        ...
        {
            var ns = typeof(FatcaComplianceService).Namespace;
            Assert.IsNotNull(ns);
        ...
        {
            var interfaces = typeof(FatcaComplianceService).GetInterfaces();
        ...
        public void Integration_Constructor_NoException()
        {
            ...
            try { var svc = new FatcaComplianceService(); }
            catch (Exception ex) { caught = ex; }
            Assert.IsNull(caught);
            Assert.IsNotNull(_service);
            Assert.IsTrue(true);
            Assert.IsFalse(false);
            Assert.AreEqual(typeof(FatcaComplianceService), _service.GetType());
        }
        ...
        public void Integration_ToString_NotNull()
        {
            ...
            Assert.IsTrue(str.Contains("FatcaComplianceService") || str.Contains("MaturityBenefitProc"));
        ...
        {
            var other = new FatcaComplianceService();
