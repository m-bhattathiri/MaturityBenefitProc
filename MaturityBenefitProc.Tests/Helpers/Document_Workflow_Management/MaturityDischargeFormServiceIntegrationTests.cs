...
{
    [TestClass]
    public class MaturityDischargeFormServiceIntegrationTests
    {
        private MaturityDischargeFormService _service;
        ...
        public void Integration_ServiceInstantiation_Succeeds()
        {
            ...
            Assert.IsInstanceOfType(_service, typeof(MaturityDischargeFormService));
            Assert.IsTrue(_service.GetType().Name == "MaturityDischargeFormService");
        ...
        {
            var s1 = new MaturityDischargeFormService();
            var s2 = new MaturityDischargeFormService();
            Assert.IsNotNull(s1);
            Assert.IsNotNull(s2);
        ...
        {
            var instances = Enumerable.Range(0, 10).Select(_ => new MaturityDischargeFormService()).ToList();
        ...
        {
            var type = typeof(MaturityDischargeFormService);
            Assert.IsNotNull(type);
            Assert.AreEqual("MaturityDischargeFormService", type.Name);
        ...
        {
            var ns = typeof(MaturityDischargeFormService).Namespace;
            Assert.IsNotNull(ns);
        ...
        {
            var interfaces = typeof(MaturityDischargeFormService).GetInterfaces();
        ...
        public void Integration_Constructor_NoException()
        {
            ...
            try { var svc = new MaturityDischargeFormService(); }
            catch (Exception ex) { caught = ex; }
            Assert.IsNull(caught);
            Assert.IsNotNull(_service);
            Assert.IsTrue(true);
            Assert.IsFalse(false);
            Assert.AreEqual(typeof(MaturityDischargeFormService), _service.GetType());
        }
        ...
        public void Integration_ToString_NotNull()
        {
            ...
            Assert.IsTrue(str.Contains("MaturityDischargeFormService") || str.Contains("MaturityBenefitProc"));
        ...
        {
            var other = new MaturityDischargeFormService();
